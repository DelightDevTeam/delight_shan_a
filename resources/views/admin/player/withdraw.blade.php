    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form action="{{route('admin.player.makeWithdraw', $player->id)}}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="" value="{{number_format($player->wallet->balance, 2)}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Amount<span class="text-danger">*</span></label>
                                    <span class="badge badge-success">Max:{{ number_format(optional($player->wallet)->balance, 2) }}</span>
