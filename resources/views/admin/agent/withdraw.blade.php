    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form action="{{route('admin.agent.makeWithdraw', $agent->id)}}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="" value="{{$agent->wallet->balance}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Amount<span class="text-danger">*</span></label>
                                    <span class="badge badge-success">Max:{{ number_format(optional($agent->wallet)->balance, 2) }}</span>
